...
struct TGAColor {
   ...
   __host__ __device__ constexpr TGAColor():TGAColor(0){};
   __host__ __device__ constexpr TGAColor(const std::uint8_t grayscale): bgra{grayscale,grayscale,grayscale,255} {}
   __host__ __device__ constexpr TGAColor(const std::uint8_t r, const std::uint8_t g, const std::uint8_t b, const std::uint8_t a): bgra{b,g,r,a} {}
   __host__ __device__ constexpr TGAColor(const std::uint8_t r, const std::uint8_t g, const std::uint8_t b): TGAColor(r,g,b,255){}
};
// known colors:
...
struct TGAImage {
   ...
   std::uint8_t* get(){return data.data();}
